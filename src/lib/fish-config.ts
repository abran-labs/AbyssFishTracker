...
export const MUTATIONS: Mutation[] = [
  ...
  { name: "Rock", multiplier: 1.0, area: "Forgotten Deep" },
  { name: "Moss", multiplier: 1.1, area: "Forgotten Deep" },
  { name: "Coral", multiplier: 1.1 },
  { name: "Metal", multiplier: 1.2 },
  { name: "Sand", multiplier: 1.25, area: "Ancient Sands" },
  { name: "Albino", multiplier: 1.3 },
  { name: "Transparent", multiplier: 1.35 },
  { name: "Cactus", multiplier: 1.45, area: "Ancient Sands" },
  { name: "Banana", multiplier: 1.5, area: "Sunken Wilds" },
  { name: "Spirit", multiplier: 1.7, area: "Spirit Roots" },
  { name: "Fossil", multiplier: 1.75, area: "Ancient Sands" },
  { name: "Golden", multiplier: 2.0 },
  { name: "Negative", multiplier: 2.0 },
  { name: "Fairy", multiplier: 2.3, area: "Spirit Roots" },
  { name: "Invisible", multiplier: 2.4 },
  { name: "Liquid", multiplier: 2.5 },
  { name: "Grounded", multiplier: 2.8, area: "Sunken Wilds" },
