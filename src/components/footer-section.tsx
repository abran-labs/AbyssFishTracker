...
export function FooterSection() {
    return (
        <Footer
            logo={null}
            brandName="Abran Labs"
            socialLinks={[
                { icon: <Github className="h-5 w-5" />, href: "https://github.com/abran-labs", label: "GitHub" },
                {
                    icon: <XIcon className="h-4 w-4" />,
                    href: "https://x.com/AbranLabs",
                    label: "X (Twitter)",
                },
                { icon: <Youtube className="h-5 w-5" />, href: "https://www.youtube.com/channel/UC0hfIt7GFnGCer6tYnYsCag", label: "YouTube" },
                { icon: <RobloxIcon className="h-5 w-5" />, href: "https://www.roblox.com/users/2373175020", label: "Roblox" },
                { icon: <DiscordIcon className="h-5 w-5" />, href: "https://discord.com/users/563879454493900821", label: "Discord" },
            ]}
            mainLinks={[]}
            legalLinks={[]}
            copyright={{
